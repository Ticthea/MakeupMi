        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="${app}/userrest/opt" class="form-horizontal" role="form">
                    <%-- 如果对于常规的增加操作,rest风格中使用post方法传递数据,所以下行代码可有可无,一般可以在form中指定method属性即可                   --%>
    ...
    function updateForm(ele) {
        ...
        $.ajax({
            ...
            success: function (result) {
                //回填数据
                $("#uidUpdateInput").val(result.dataZone.obj.uid);
                $("#usernameUpdateInput").val(result.dataZone.obj.username);
