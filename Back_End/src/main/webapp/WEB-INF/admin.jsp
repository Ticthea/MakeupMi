...
<nav class="navbar navbar-expand-md bg-primary navbar-dark fixed-top">
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link" target="dataDisplay" href="${app}/user/list">管理员管理(多页)</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" target="dataDisplay" href="${app}/userrest/index1">管理员管理(REST客户端单页)</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" target="dataDisplay" href="${app}/userrest/index">管理员管理(REST客户端封装)</a>
            </li>
            <li class="nav-item">
